...
def main():
    ...
    csv_path = "./progress_report/GCAF25C1-IN-T3K-Y7E [20 Apr].csv"
    ...
    if st.session_state.search_active and st.session_state.search_results is not None:
        ...
        st.markdown(f'<div style="text-align: left; font-family: \'Press Start 2P\', cursive; font-size: 1rem; color: #DB4437; margin-bottom: 10px;">Last Updated: April 20, 2025</div>', unsafe_allow_html=True)
